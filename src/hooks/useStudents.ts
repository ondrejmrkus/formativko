...
export function useUpdateStudent() {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({ id, first_name, last_name, svp, notes, interests, communication_preferences, learning_styles, svp_details }: {
      id: string;
      first_name: string;
      last_name: string;
      svp?: boolean;
...
// Re-export student utilities for backward compatibility during migration
export { getStudentDisplayName, getStudentShortName } from "@/utils/student";
